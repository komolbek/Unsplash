...
if [[ "$CONFIGURATION" == "Debug Development" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Framezilla/Framezilla.framework"
...
if [[ "$CONFIGURATION" == "AdHoc Development" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Framezilla/Framezilla.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nuke/Nuke.framework"
fi
if [[ "$CONFIGURATION" == "AdHoc Staging" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Framezilla/Framezilla.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nuke/Nuke.framework"
fi
if [[ "$CONFIGURATION" == "AdHoc Production" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Framezilla/Framezilla.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Nuke/Nuke.framework"
fi
